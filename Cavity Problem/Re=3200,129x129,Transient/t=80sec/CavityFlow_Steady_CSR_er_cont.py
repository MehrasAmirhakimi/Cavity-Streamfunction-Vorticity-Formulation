...
U[1:im,1:jm]=np.reshape(u[nm+nmp,:],[im-1,jm-1])
U[im,:]=1
...
V[1:im,1:jm]=np.reshape(v[nm+nmp,:],[im-1,jm-1])
...
SAI[1:im,1:jm]=np.reshape(sai[nm+nmp,:],[im-1,jm-1])
...
OMEGA[1:im,1:jm]=np.reshape(omega[nm+nmp,:],[im-1,jm-1])
